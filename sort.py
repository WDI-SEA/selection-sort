...
# recursion practice
def selection_recursion(li, sorted = 0):
  # base case
  if sorted >= len(li):
    return li
  min = sorted
  # recursive case
  for i in range(min + 1, len(li)):
    if li[min] > li[i]:
      min = i
  li[sorted], li[min] = li[min], li[sorted]
  return selection_recursion(li, sorted + 1)
...
# numbers list is too big for default recursion limit lol
selection_recursion(numbers)
print(numbers)
print(is_sorted(numbers))

# selection_recursion(li)
# print(li)
# print(is_sorted(li))